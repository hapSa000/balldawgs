  ...
  return (
    <View
      ...
      <View style={tw`my-auto mx-2`}>
        ...
        //   }}
        //   style={tw`flex flex-row`}>
        //   <Text style={tw`my-auto text-base font-bold`}>Logout</Text>
        //   <MaterialCommunityIcons
        //     name="lock"
        //     style={tw`my-auto text-xl ml-1`}
        //   />
        // </TouchableOpacity>
      ...
      </View>
            {
              ...
              <>
              <View style={{backgroundColor:'red',borderRadius:15,borderWidth:2, width:30,height:30,borderColor:'#aaa', marginLeft:20}}>
              <Text style={tw`my-auto mx-2 font-bold text-sm`}>1</Text>
              <TouchableOpacity style={{position:'absolute',right:20,top:3}}
                onPress={() =>
